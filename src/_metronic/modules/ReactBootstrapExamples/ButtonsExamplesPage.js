...
import { Notice, KTCodeExample } from '../../_partials/controls';
...
class LoadingButton extends React.Component {
  ...
  render() {
    ...
    return (
      <Button variant="primary" disabled={isLoading} onClick={!isLoading ? this.handleClick : null}>
    ...
    return (
      <>
        <Notice icon="flaticon-warning font-primary">
          <span>
            Custom button styles for actions in forms, dialogs, and more with support for multiple
        ...
        <div className="row">
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode1} beforeCodeTitle="Examples">
              <span>
                ...
                modify the <code> variant </code> prop.
              </span>
            ...
            <KTCodeExample jsCode={jsCode3} beforeCodeTitle="Button tags">
              <span>
                ...
                render whatever your heart desires.React Bootstrap will take care of the proper ARIA
                roles for you.
              </span>
              <div className="separator separator-dashed my-7" />
              <ButtonToolbar className="pb-2">
                ...
                <span className="pr-1">
                  <Button as="input" type="button" value="Input" onChange={() => {}} />
                </span>
              </ButtonToolbar>
              <ButtonToolbar>
                <span className="pr-1">
                  <Button as="input" type="submit" value="Submit" onChange={() => {}} />
                </span>
                <span className="pr-1">
                  <Button as="input" type="reset" value="Reset" onChange={() => {}} />
                </span>
              </ButtonToolbar>
            </KTCodeExample>
            ...
            <KTCodeExample jsCode={jsCode9} beforeCodeTitle="Checkbox / Radio">
              <span>
                Button 's can also be used to style <code>checkbox</code> and <code> radio </code>
                form elements. This is helpful when you want a toggle button that works neatly
                inside an HTML form.
              </span>
              <div className="separator separator-dashed my-7" />
          ...
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode2} beforeCodeTitle="Outline buttons">
              <span>
                For a lighter touch, Buttons also come in <code> outline - * </code> variants with
                no background color.
              </span>
              <div className="separator separator-dashed my-7" />
              <ButtonToolbar>
            ...
            <KTCodeExample jsCode={jsCode6} beforeCodeTitle="Active state">
              <span>
                To set a buttons active state simply set the components <code> active </code> prop.
              </span>
              <div className="separator separator-dashed my-7" />
              <ButtonToolbar>
                <span className="pr-4">
            ...
            <KTCodeExample jsCode={jsCode8} beforeCodeTitle="Button loading state">
              <span>
            ...
            <KTCodeExample jsCode={jsCode10} beforeCodeTitle="Uncontrolled">
              <div className="mb-3">
                <ButtonToolbar>
                  <ToggleButtonGroup type="checkbox" defaultValue={[1, 3]} name="Uncontrolled">
