      ...
      <>
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <KTCodeExample jsCode={jsCode3} beforeCodeTitle="Title, text, and links">
              <span>
                Using <code> &lt; Card.Title &gt; </code>,<code> &lt; Card.Subtitle &gt; </code>,
                and <code> &lt; Card.Text &gt; </code>
                inside the <code> &lt; Card.Body &gt; </code> will line them up nicely.
            ...
            <KTCodeExample jsCode={jsCode11} beforeCodeTitle="Border Color" codeBlockHeight="400px">
              <>
                <Card
                  border="primary"
                  style={{
            ...
            <KTCodeExample jsCode={jsCode9} beforeCodeTitle="Navigation">
              <span>
                Add some navigation to a card’ s header(or block) with React Bootstrap’ s Nav
                components.
              </span>
              <div className="separator separator-dashed my-7"> </div>
              <Card>
            ...
            <KTCodeExample jsCode={jsCode13} beforeCodeTitle="Card Deck" codeBlockHeight="400px">
              <CardDeck>
                <Card>
                  <Card.Img
                    variant="top"
          ...
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode7} beforeCodeTitle="Image caps" codeBlockHeight="400px">
              <span>
            ...
            <KTCodeExample jsCode={jsCode4} beforeCodeTitle="List Groups">
              <span>Create lists of content in a card with a flush list group. </span>
              <div className="separator separator-dashed my-7"> </div>
              <Card
                style={{
                  width: '18rem',
            ...
            <KTCodeExample jsCode={jsCode12} beforeCodeTitle="Card Groups" codeBlockHeight="400px">
              <CardGroup>
                <Card>
                  <Card.Img
                    variant="top"
            ...
            <KTCodeExample jsCode={jsCode14} beforeCodeTitle="Card Columns" codeBlockHeight="400px">
              <CardColumns>
                <Card>
                  <Card.Img
                    variant="top"
