          ...
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode1} beforeCodeTitle="Examples">
              <span>
                ...
                button.For proper styling, use one of the eight <code> variant </code>s.
              </span>
            ...
            <KTCodeExample jsCode={jsCode3} beforeCodeTitle="Additional content">
              <span>
                Alerts can contain whatever content you like.Headers, paragraphs, dividers, go
                crazy.
              </span>
              <div className="separator separator-dashed my-7"> </div>
            ...
            <KTCodeExample jsCode={jsCode4} beforeCodeTitle="Dismissing">
              ...
              <div className="separator separator-dashed my-7"> </div> <AlertDismissibleExample />
            </KTCodeExample>
          </div>
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode2} beforeCodeTitle="Links">
              <span>
                For links, use the <code> & lt; Alert.Link & gt; </code> component to provide
              ...
              <div>
                {[
                  ...
                  <Alert key={idx} variant={variant}>
                    This is a {variant}
                    alert with & nbsp; <Alert.Link href="#"> an example link </Alert.Link>. Give it
                    a click if you like.
                  </Alert>
                ))}
              </div>
            ...
            <KTCodeExample jsCode={jsCode5} beforeCodeTitle="Dismissing">
              <span>
                You can also control the visual state directly which is great if you want to build
                more complicated alerts.
              </span>
              <div className="separator separator-dashed my-7"> </div> <AlertDismissible />
            </KTCodeExample>
          </div>
        </div>
      </>
