      ...
      <div className="row">
        <div className="col-md-6">
          ...
          <KTCodeExample jsCode={jsCode5} beforeCodeTitle="Controlled Tooltips">
            <span>
              You can use the <code>open</code>, <code>onOpen</code> and <code>onClose</code>
        ...
        <div className="col-md-6">
          <KTCodeExample jsCode={jsCode2} beforeCodeTitle="Positioned Tooltips">
            <span>
              The <code>Tooltip</code> has 12 placements choice. They don’t have directional arrows;
          ...
          <KTCodeExample jsCode={jsCode4} beforeCodeTitle="Triggers">
            <span>You can define the types of events that cause a tooltip to show.</span>
            <div className="separator separator-dashed my-7"></div>
            <div>
              <Grid container justify="center">
                <Grid item>
          ...
          <KTCodeExample jsCode={jsCode6} beforeCodeTitle="Variable Width">
            ...
            <div>
              <Tooltip title={longText6}>
                <Button className={classes6.button}>Default Width [300px]</Button>
              </Tooltip>
              <Tooltip title={longText6} classes={{ tooltip: classes6.customWidth }}>
                <Button className={classes6.button}>Custom Width [500px]</Button>
              </Tooltip>
              <Tooltip title={longText6} classes={{ tooltip: classes6.noMaxWidth }}>
          ...
          <KTCodeExample jsCode={jsCode8} beforeCodeTitle="Disabled Elements">
            <span>
              ...
              interactions so a <code>Tooltip</code> will not activate on normal events like hover.
              To accommodate disabled elements, add a simple wrapper element like a<code>span</code>
              .
            </span>
            <div className="separator separator-dashed my-7"></div>
