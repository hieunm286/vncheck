    ...
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        <li className="menu-section ">
          <h4 className="menu-text">Quản trị</h4>
        ...
        {/*User management*/}
        <li
          className={`menu-item menu-item-submenu ${getMenuItemActive('/account', true)}`}
          aria-haspopup="true"
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item  ${getMenuItemActive('/account/user')}`}
                aria-haspopup="true">
        ...
        {/* begin::section */}
        <li className="menu-section ">
          <h4 className="menu-text">Danh mục dữ liệu</h4>
          <i className="menu-icon flaticon-more-v2"></i>
        </li>
        {/* end:: section */}
        ...
        {/*Danh mục dữ liệu */}
        <li
          className={`menu-item menu-item-submenu ${getMenuItemActive('/product-category', true)}`}
          aria-haspopup="true"
          data-menu-toggle="hover">
          <NavLink className="menu-link menu-toggle" to="/product-category">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl('/media/svg/icons/Design/Cap-2.svg')} />
            </span>
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item  ${getMenuItemActive('/product-category/product')}`}
                aria-haspopup="true">
                <NavLink className="menu-link" to="/product-category/product">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
              ...
              <li
                className={`menu-item  ${getMenuItemActive('/product-category/product-group')}`}
                aria-haspopup="true">
                <NavLink className="menu-link" to="/product-category/product-group">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
