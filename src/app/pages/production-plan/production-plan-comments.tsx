...
const ProductionPlanComments = ({ entity, onComments }: { entity: any; onComments: (entity: any, data: { content: string }) => Promise<AxiosResponse<any>>; }) => {
...
export default ProductionPlanComments
