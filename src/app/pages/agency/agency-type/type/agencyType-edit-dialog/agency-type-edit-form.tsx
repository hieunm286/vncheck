...
export function AgencyTypeEditForm({ saveAgencyType, agencyType, actionsLoading, onHide }) {
  const [state, setState] = React.useState({
    type_status: agencyType.type_status == 0 ? true : false,
  });

  useEffect(() => {
    setState({ type_status: agencyType.type_status == 0 ? true : false });
            ...
            <Modal.Body className="overlay overlay-block cursor-default">
              ...
              <Form className="form form-label-right">
                ...
                <Field
                  ...
                  withValidation
                  isHorizontal
                  disabled={agencyType.agency_type_id !== '' ? true : false}
                  label="Mã loại:"
                />
                <div>
