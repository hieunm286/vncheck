...
export function PaginationToolbar({isLoading, paginationProps}: { isLoading: boolean, paginationProps: PaginationOptions }) {
  const intl = useIntl();
  const {
    ...
    <div className="d-flex align-items-center py-3">
      {isLoading && (
        <div className="d-flex align-items-center">
          <div className="mr-2 text-muted">{intl.formatMessage({id: 'COMMON_COMPONENT.PAGINATION.LOADING'})}</div>
