  ...
  return (
    <Fragment>
      ...
      {renderInfo && showIndex > -1 && (<div className={'image-detail-info pl-10 pt-13 pr-10 pb-12'}>
        ...
        {renderInfo.data && Object.keys(renderInfo.data).map((key, index) => (
...
//                pathField,
//                onImageRemove
//              }: { renderInfo?: any, onImageRemove?: (...props: any) => void, image: any, index: number, width: number | string, height: number | string, pathField: string }) => {
//   const container = useRef<any>(null);
//   const [show, setShow] = useState(false);
//   return (<div className="image-item imagePreview mr-1">
//     <Image
//       width={width}
//       height={height}
//       className={'image-detail cursor-pointer'}
...
//             <CloseOutlined/>
//           </span>}
//     {renderInfo && (<div className={(show ? '' : 'hidden ') + 'image-detail-info pl-10 pt-13 pr-10'}>
//       {renderInfo.title && (
//         <div className={'pb-3'} style={{fontSize: '24px'}}>{intl.formatMessage({id: renderInfo.title})}</div>)}
//       {renderInfo.data && Object.keys(renderInfo.data).map((key, index) => (
//         <div className={'titleeee mb-1'} key={key}>{intl.formatMessage({id: renderInfo.data[key]})} {image[key]}</div>
//       ))}
//       {renderInfo.component && renderInfo.component(image, values)}
//     </div>)}
//   </div>)
// };
