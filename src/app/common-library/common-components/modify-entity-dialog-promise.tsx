...
import ModifyEntityFormPromise from './modify-entity-form-promise';

function ModifyEntityDialogPromise<T>({
  isShow,
  onHide,
  entity,
  onModify,
...
export default ModifyEntityDialogPromise;
