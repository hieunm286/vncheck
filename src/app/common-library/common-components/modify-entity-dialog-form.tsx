...
function ModifyEntityDialogForm<T>({entity, onHide, onModify, modifyModel}:
                                     { entity: T; onHide: () => void; onModify: (values: any) => void; modifyModel: ModifyModel }) {
  const intl = useIntl();
        ...
        <>
          <Modal.Body className="overlay overlay-block cursor-default">
            ...
            <Form className="form form-label-right">
              {modifyModel ? Object.keys(modifyM).map((key) => {
