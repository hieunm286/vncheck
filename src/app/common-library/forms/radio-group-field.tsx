...
export const FormikRadioGroup = ({
  ...
  const handleAddressChange = (e: any) => {
    ...
    let defaultAddress = values.shippingAddress.find((addr: any) => {
      return addr._id === selectedIdx
    });
  ...
  return (
    <React.Fragment>
      <RadioGroup aria-label={ariaLabel} name={name} value={currentAddress}
            ...
            <div className="mt-3 row" key={key}>
              <React.Fragment>
                <div className="col-md-10 col-12">
                  <FormControlLabel name="defaultShippingAddress" value={entity._id} control={<StyledRadio/>}
                                    label={getShippingAddress(entity)}/>
                </div>
