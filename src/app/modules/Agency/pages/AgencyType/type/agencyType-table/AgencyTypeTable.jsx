...
import * as uiHelpers from '../AgencyTypeUIHelpers';
import * as columnFormatters from './column-formatters';
import { Pagination } from '../../../../../../../_metronic/_partials/controls';
import { useAgencyTypeUIContext } from '../AgencyTypeUIContext';
import './AgencyTypeTable.scss';
import { AgencyTypeEditForm } from '../agencyType-edit-dialog/AgencyTypeEditForm';
  ...
  const rowEvents = {
    onClick: (e, row, rowIndex) => {
      if (e.target.tagName.toLowerCase() === 'td') {
        dispatch(actions.fetchAgencyTypeViewById(row.agency_type_id));
      }
    },
  };
